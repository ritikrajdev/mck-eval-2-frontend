...
export const mockRegistrationUpdateBody = {
  isRegistered: true,
};

export const mockBookmarkUpdateBody = {
  isBookmarked: true,
};

export const mockRegistrationSuccess = 'Event Updated!!!';
export const mockBookmarkSuccess = 'Event Updated!!!';
